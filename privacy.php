...
<head>
    ...
    <title>PlayLearn - Privacy Policy</title>
...
<div class="h-screen w-full grid lg:grid-cols-2">
    ...
    <div class="flex flex-col pt-16 px-8 pb-8 lg:px-16 lg:pb-16 bg-background h-full relative">
        <div class="flex-1 overflow-hidden flex flex-col">
            ...
            <p class="text-muted-foreground text-sm mb-6">Last updated: April 27, 2026</p>

            <div class="flex-1 overflow-y-auto pr-4 content-scroll space-y-6 text-sm leading-relaxed text-slate-600">
                <section>
                    <h2 class="text-lg font-bold text-primary mb-2">1. Information We Collect</h2>
                    <p>At PlayLearn, we prioritize the safety of our young explorers. We collect minimal personal information necessary for account creation and game performance tracking, including your username, email address, and birth date.</p>
                </section>
                <section>
                    <h2 class="text-lg font-bold text-primary mb-2">2. How We Use Your Data</h2>
                    <p>The information we collect is used to:
                        <ul class="list-disc ml-5 mt-2 space-y-1">
                            <li>Provide a personalized educational experience.</li>
                            <li>Track game progress and high scores.</li>
                            <li>Send essential account notifications and OTP codes.</li>
                            <li>Ensure safety and prevent unauthorized access.</li>
                        </ul>
                    </p>
                </section>
                <section>
                    <h2 class="text-lg font-bold text-primary mb-2">3. Data Security</h2>
                    <p>We implement industry-standard encryption to protect your password and personal details. We never sell or share your data with third-party advertisers.</p>
                </section>
                <section>
                    <h2 class="text-lg font-bold text-primary mb-2">4. Parental Rights</h2>
                    <p>Parents have full control over their child's account. You may request to view, modify, or delete your child's information at any time through the Parent Dashboard.</p>
                </section>
                <section>
                    <h2 class="text-lg font-bold text-primary mb-2">5. Cookies</h2>
                    <p>We use essential cookies to keep you logged in and remember your game settings. These cookies do not track your activity on other websites.</p>
                </section>
            </div>
