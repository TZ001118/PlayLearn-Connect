                ...
                <div class="flex gap-4 relative" style="z-index: 101;">
                    <div class="flex-1 space-y-1">
                        ...
                        <div class="flex gap-2">
                            <div class="role-option selected flex-1 text-center py-2 border border-border/60 rounded-md cursor-pointer transition-colors text-xs font-medium" data-value="player" onclick="selectRole(this)">Children</div>
                            <div class="role-option flex-1 text-center py-2 border border-border/60 rounded-md cursor-pointer transition-colors text-xs font-medium" data-value="parent" onclick="selectRole(this)">Parent</div>
                        </div>
                        <input type="hidden" id="selectedRole" value="player">
                    </div>
                    <div class="flex-1 space-y-1">
...
<script>
    ...
    const yearsData = []; const currentYear = new Date().getFullYear();
