...
-- Generation Time: May 31, 2026 at 03:04 AM
...
--
-- Table structure for table `game_age_bands`
--

CREATE TABLE `game_age_bands` (
  `game_id` int(11) NOT NULL,
  `min_age` tinyint(3) UNSIGNED NOT NULL DEFAULT 4,
  `max_age` tinyint(3) UNSIGNED NOT NULL DEFAULT 12,
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `game_age_bands`
--

INSERT INTO `game_age_bands` (`game_id`, `min_age`, `max_age`, `updated_at`) VALUES
(5, 4, 12, '2026-05-27 20:09:44'),
(6, 4, 12, '2026-05-27 20:09:44'),
(7, 4, 12, '2026-05-27 20:09:44'),
(8, 4, 12, '2026-05-27 20:09:44'),
(10, 4, 12, '2026-05-27 20:09:44'),
(11, 4, 12, '2026-05-27 20:09:44'),
(12, 4, 12, '2026-05-27 20:09:44'),
(14, 4, 12, '2026-05-27 20:09:44'),
(15, 7, 12, '2026-05-28 10:43:51');
...
CREATE TABLE `game_scores` (
  ...
  `reaction_time_ms` int(11) DEFAULT NULL,
...
--
-- Table structure for table `game_skill_weights`
--

CREATE TABLE `game_skill_weights` (
  `id` int(11) NOT NULL,
  `game_id` int(11) NOT NULL,
...
--
-- Dumping data for table `game_skill_weights`
--

INSERT INTO `game_skill_weights` (`id`, `game_id`, `skill_key`, `weight`, `updated_at`) VALUES
(1, 5, 'math', 0, '2026-05-27 20:09:44'),
(2, 5, 'logic', 15, '2026-05-27 20:09:44'),
(3, 5, 'memory', 25, '2026-05-27 20:09:44'),
(4, 5, 'focus', 25, '2026-05-27 20:09:44'),
(5, 5, 'speed', 0, '2026-05-27 20:09:44'),
(6, 5, 'creativity', 35, '2026-05-27 20:09:44'),
(7, 6, 'math', 0, '2026-05-27 20:09:44'),
(8, 6, 'logic', 20, '2026-05-27 20:09:44'),
(9, 6, 'memory', 0, '2026-05-27 20:09:44'),
(10, 6, 'focus', 35, '2026-05-27 20:09:44'),
(11, 6, 'speed', 45, '2026-05-27 20:09:44'),
(12, 6, 'creativity', 0, '2026-05-27 20:09:44'),
(13, 7, 'math', 20, '2026-05-27 20:09:44'),
(14, 7, 'logic', 50, '2026-05-27 20:09:44'),
(15, 7, 'memory', 10, '2026-05-27 20:09:44'),
(16, 7, 'focus', 20, '2026-05-27 20:09:44'),
(17, 7, 'speed', 0, '2026-05-27 20:09:44'),
(18, 7, 'creativity', 0, '2026-05-27 20:09:44'),
(19, 8, 'math', 20, '2026-05-27 20:09:44'),
(20, 8, 'logic', 50, '2026-05-27 20:09:44'),
(21, 8, 'memory', 10, '2026-05-27 20:09:44'),
(22, 8, 'focus', 20, '2026-05-27 20:09:44'),
(23, 8, 'speed', 0, '2026-05-27 20:09:44'),
(24, 8, 'creativity', 0, '2026-05-27 20:09:44'),
(25, 10, 'math', 55, '2026-05-27 20:09:44'),
(26, 10, 'logic', 25, '2026-05-27 20:09:44'),
(27, 10, 'memory', 0, '2026-05-27 20:09:44'),
(28, 10, 'focus', 20, '2026-05-27 20:09:44'),
(29, 10, 'speed', 0, '2026-05-27 20:09:44'),
(30, 10, 'creativity', 0, '2026-05-27 20:09:44'),
(31, 11, 'math', 0, '2026-05-27 20:09:44'),
(32, 11, 'logic', 0, '2026-05-27 20:09:44'),
(33, 11, 'memory', 55, '2026-05-28 17:10:06'),
(34, 11, 'focus', 25, '2026-05-28 17:10:06'),
(35, 11, 'speed', 20, '2026-05-28 17:10:06'),
(36, 11, 'creativity', 0, '2026-05-27 20:09:44'),
(37, 12, 'math', 55, '2026-05-27 20:09:44'),
(38, 12, 'logic', 25, '2026-05-27 20:09:44'),
(39, 12, 'memory', 0, '2026-05-27 20:09:44'),
(40, 12, 'focus', 20, '2026-05-27 20:09:44'),
(41, 12, 'speed', 0, '2026-05-27 20:09:44'),
(42, 12, 'creativity', 0, '2026-05-27 20:09:44'),
(43, 14, 'math', 20, '2026-05-28 17:09:32'),
(44, 14, 'logic', 50, '2026-05-27 20:09:44'),
(45, 14, 'memory', 10, '2026-05-27 20:09:44'),
(46, 14, 'focus', 20, '2026-05-27 20:09:44'),
(47, 14, 'speed', 0, '2026-05-27 20:09:44'),
(48, 14, 'creativity', 0, '2026-05-27 20:09:44'),
(49, 15, 'math', 10, '2026-05-28 10:43:51'),
(50, 15, 'logic', 40, '2026-05-28 10:43:51'),
(51, 15, 'memory', 20, '2026-05-28 10:43:51'),
(52, 15, 'focus', 20, '2026-05-28 10:43:51'),
(53, 15, 'speed', 10, '2026-05-28 10:43:51'),
(54, 15, 'creativity', 0, '2026-05-28 10:43:51');
...
CREATE TABLE `levels` (
  ...
  `custom_slug` varchar(80) DEFAULT NULL,
  `package_path` varchar(255) DEFAULT NULL,
  `package_status` enum('published','draft','rejected') NOT NULL DEFAULT 'published',
  `package_manifest` text DEFAULT NULL,
...
INSERT INTO `levels` (`id`, `level_name`, `category`, `level_description`, `difficulty`, `target_score`, `image_url`, `game_url`, `custom_slug`, `package_path`, `package_status`, `package_manifest`, `status`, `created_at`, `is_featured`, `is_trending`, `editor_choice`) VALUES
(5, 'Word Wanderer', 'Focus', 'Great!', 'Hard', 0, 'assets/uploads/levels/1777121129_69ecb7698ab16.png', 'games/word_wanderer.php', NULL, NULL, 'published', NULL, 'published', '2026-04-25 12:45:29', 1, 1, 0),
(6, 'Snake', 'Speed', 'Great', 'Normal', 0, 'assets/uploads/levels/1777121151_69ecb77f83bbe.png', 'games/snake.php', NULL, NULL, 'published', NULL, 'published', '2026-04-25 12:45:51', 0, 0, 0),
(7, 'Odd One Out', 'Logic', 'Great!', 'Easy', 0, 'assets/uploads/levels/1777121266_69ecb7f28ba47.jpeg', 'games/odd_one_out.php', NULL, NULL, 'published', NULL, 'published', '2026-04-25 12:46:12', 0, 0, 0),
(8, 'Mine Sweeper', 'Logic', 'Great!', 'Hard', 0, 'assets/uploads/levels/1777121197_69ecb7ade21f8.png', 'games/minesweeper.php', NULL, NULL, 'published', NULL, 'published', '2026-04-25 12:46:38', 0, 0, 0),
(10, 'Math Pop', 'Speed', 'Great!', 'Easy', 0, 'assets/uploads/levels/1777121232_69ecb7d039f22.png', 'games/math_pop.php', NULL, NULL, 'published', NULL, 'published', '2026-04-25 12:47:12', 0, 1, 0),
(11, 'Emoji Memory Match', 'Memory', 'Great', 'Normal', 0, 'assets/uploads/levels/1777121260_69ecb7ec0c402.png', 'games/memory.php', 'game-1779988191', NULL, 'published', NULL, 'published', '2026-04-25 12:47:40', 0, 0, 0),
(12, 'Math Merge 2048', 'Logic', 'Great!', 'Normal', 0, 'assets/uploads/levels/1777121293_69ecb80d63df6.png', 'games/game2048.php', NULL, NULL, 'published', NULL, 'published', '2026-04-25 12:48:13', 0, 1, 0),
(15, 'Pattern Sprint', 'Logic', 'A small sample game package that demonstrates the PlayLearn SDK.', 'Easy', 0, 'games/custom/pattern-sprint/cover.svg', 'game_player.php?id=15', 'pattern-sprint', 'games/custom/pattern-sprint', 'published', '{\"title\":\"Pattern Sprint\",\"slug\":\"pattern-sprint\",\"description\":\"A small sample game package that demonstrates the PlayLearn SDK.\",\"category\":\"Logic\",\"difficulty\":\"Easy\",\"age\":{\"min\":7,\"max\":12},\"skills\":{\"math\":10,\"logic\":40,\"memory\":20,\"focus\":20,\"speed\":10,\"creativity\":0},\"entry\":\"index.html\",\"cover\":\"cover.svg\"}', 'published', '2026-05-28 10:43:51', 0, 0, 0);
...
--
-- Table structure for table `parent_learning_targets`
--

CREATE TABLE `parent_learning_targets` (
  `id` int(11) NOT NULL,
  `parent_id` int(11) NOT NULL,
  `child_id` int(11) NOT NULL,
  `skill_key` varchar(30) NOT NULL,
  `target_value` tinyint(3) UNSIGNED NOT NULL DEFAULT 70,
...
('maintenance_mode', '1'),
('maintenance_eta', '15'),
('maintenance_expires_at', '2026-05-29 01:25:33');
...
(584, 20, 'teoruize044', 'player', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-27 20:09:42'),
(585, 20, 'teoruize044', 'player', 'Logout', 'User logged out safely', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-27 20:10:13'),
(586, 19, 'teoruize045', 'parent', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-27 20:10:16'),
(587, 19, 'teoruize045', 'parent', 'Security Violation', 'Unauthorized score submission attempt', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Unauthorized', '2026-05-27 20:11:22'),
(588, 19, 'teoruize045', 'parent', 'Logout', 'User logged out safely', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-27 20:24:16'),
(589, NULL, 'Guest', 'Visitor', 'Login Attempt', 'Failed password for: Heng', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Failed', '2026-05-28 08:21:58'),
(590, 20, 'teoruize044', 'player', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 08:32:51'),
(591, 19, 'teoruize045', 'parent', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 08:34:17'),
(592, 1, 'Heng', 'admin', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 08:35:30'),
(593, 20, 'teoruize044', 'player', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 08:38:29'),
(594, 19, 'teoruize045', 'parent', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 08:43:37'),
(595, 19, 'teoruize045', 'parent', 'Logout', 'User logged out safely', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 08:59:57'),
(596, 20, 'teoruize044', 'player', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 09:00:03'),
(597, 20, 'teoruize044', 'player', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 09:03:23'),
(598, 20, 'teoruize044', 'player', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 09:14:48');
INSERT INTO `system_logs` (`log_id`, `user_id`, `username`, `role`, `action`, `details`, `ip_address`, `user_agent`, `status`, `created_at`) VALUES
(599, 20, 'teoruize044', 'player', 'Game Score', 'Saved score 512 for game: Math Merge 2048 (Lvl 3)', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 09:14:55'),
(600, 20, 'teoruize044', 'player', 'Game Score', 'Saved score 18 for game: Emoji Memory Match (Lvl 2)', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 09:14:55'),
(601, 20, 'teoruize044', 'player', 'Logout', 'User logged out safely', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 10:37:22'),
(602, 1, 'Heng', 'admin', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 10:37:35'),
(603, 19, 'teoruize045', 'parent', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 10:45:42'),
(604, 19, 'teoruize045', 'parent', 'Logout', 'User logged out safely', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 10:45:47'),
(605, 20, 'teoruize044', 'player', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 10:45:52'),
(606, 20, 'teoruize044', 'player', 'Game Score', 'Saved score 125 for game: Pattern Sprint (Lvl 3)', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 10:46:16'),
(607, 20, 'teoruize044', 'player', 'Game Score', 'Saved score 125 for game: Pattern Sprint (Lvl 4)', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 10:46:28'),
(608, 20, 'teoruize044', 'player', 'Game Score', 'Saved score 125 for game: Pattern Sprint (Lvl 5)', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 10:46:52'),
(609, 20, 'teoruize044', 'player', 'Game Score', 'Saved score 125 for game: Pattern Sprint (Lvl 6)', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 10:47:03'),
(610, 20, 'teoruize044', 'player', 'Game Score', 'Saved score 400 for game: Pattern Sprint (Lvl 7)', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 10:47:15'),
(611, 20, 'teoruize044', 'player', 'Logout', 'User logged out safely', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 10:47:43'),
(612, 1, 'Heng', 'admin', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 10:48:19'),
(613, 1, 'Heng', 'admin', 'Review Management', 'Admin deleted review ID #4', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 16:23:12'),
(614, 1, 'Heng', 'admin', 'Review Management', 'Admin deleted review ID #1', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 17:08:18'),
(615, 1, 'Heng', 'admin', 'System Maintenance', 'Admin ENABLED (Estimated: 15 mins) maintenance mode', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 17:10:33'),
(616, 20, 'teoruize044', 'player', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Linux; Android 14; V2130) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/123.0.6312.118 Mobile Safari/537.36 VivoBrowser/15.0.0.5', 'Success', '2026-05-28 17:11:08'),
(617, 1, 'Heng', 'admin', 'Preference Change', 'Admin updated UI theme to dark', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 17:12:23'),
(618, 1, 'Heng', 'admin', 'Preference Change', 'Admin updated UI theme to light', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-28 17:48:02'),
(619, 1, 'Heng', 'admin', 'Login', 'User logged in successfully', '14.192.212.129', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', 'Success', '2026-05-31 06:54:36');
...
INSERT INTO `users` (`id`, `username`, `profile_image`, `avatar_frame`, `frame_expires_at`, `title`, `title_expires_at`, `email`, `password`, `birthday`, `gender`, `ic_number`, `role`, `level`, `total_exp`, `weekly_exp`, `link_code`, `status`, `ban_reason`, `banned_at`, `last_login`, `created_at`, `last_seen`, `theme_preference`) VALUES
(1, 'Heng', NULL, NULL, NULL, NULL, NULL, 'junhengtoh@gmail.com', '$2y$10$Qaho/XATr4UdskDPbu83QuA0H8Dak03VarZn8Kk.Tyo62B.RLtzOy', '2006-09-12', '', NULL, 'admin', 1, 0, 0, NULL, 'active', NULL, NULL, '2026-05-31 14:54:36', '2026-04-22 15:04:08', '2026-05-31 14:54:36', 'light'),
(2, 'Abc', NULL, NULL, NULL, NULL, NULL, 'Abc@gmail.com', '$2y$10$vW6Ea09cXdp32nqRTrsbcO4//Yz4K8OuhvLwO8Fw8y56Yt6.dumpG', '2023-01-01', 'girl', NULL, 'player', 1, 0, 0, 'C9F940', 'active', NULL, NULL, '2026-05-20 09:53:20', '2026-04-22 15:06:46', '2026-05-20 09:53:20', 'dark'),
(17, 'Abc1', NULL, NULL, NULL, NULL, NULL, 'forgarenagame8787@gmail.com', '$2y$10$tRFwq4dXSEr5B6F6/nN5rurKXMj3nGi0wF6bpel9liuDJbt9rt5Jq', '2014-01-01', '', NULL, 'player', 1, 0, 0, 'A569A1', 'active', NULL, NULL, '2026-04-26 22:59:23', '2026-04-23 15:06:53', '2026-04-26 23:12:22', 'dark'),
(18, 'A', 'uploads/avatars/avatar_18_1779162443.png', NULL, NULL, NULL, NULL, 'youhong0311@gmail.com', '$2y$10$2p9qgxOqtBhF/cqYUy/2weJ72puOmUfTLVehcS9Z4FrDVchOZuRW2', '2006-11-03', 'boy', NULL, 'player', 1, 0, 0, 'E95104', 'active', NULL, NULL, '2026-05-20 09:19:29', '2026-04-26 05:33:22', '2026-05-20 09:24:26', 'dark'),
(19, 'teoruize045', NULL, NULL, NULL, NULL, NULL, 'teoruize001@gmail.com', '$2y$10$caew4P9ZXbB9rZ3Q810/3.1nToQDX7/1LsNUjfVeomaMEJeSHD4Re', '2026-02-02', 'boy', NULL, 'parent', 1, 0, 0, NULL, 'active', NULL, NULL, '2026-05-28 18:45:42', '2026-04-26 19:46:45', '2026-05-28 18:45:42', 'dark'),
(20, 'teoruize044', 'uploads/avatars/avatar_20_1778959848.png', 'assets/avatar_frames/star_burst.svg', '2026-05-27 00:20:57', NULL, NULL, 'teoruize044@gmail.com', '$2y$10$stq17Uc5y8ZazS9HlcadI.BknEGa65tTBgV3a8R/OcTByMPoXbOGO', '2005-02-03', 'boy', NULL, 'player', 8, 3540, 1530, '8E5993', 'active', NULL, NULL, '2026-05-29 01:11:08', '2026-04-27 01:01:05', '2026-05-29 01:11:08', 'dark'),
(23, 'jayden', NULL, NULL, NULL, NULL, NULL, 'jaydenlow88888@gmail.com', '$2y$10$dxqOrRmtyn5kamn6O9H1COfsC9Rfa2EtX01cmvji4TJhBiZaGrf.y', '2006-05-20', 'boy', NULL, 'player', 1, 0, 0, 'E7C139', 'active', NULL, NULL, '2026-04-26 22:22:19', '2026-04-27 04:00:01', '2026-04-26 22:22:19', 'dark'),
(24, 'ruize', NULL, NULL, NULL, NULL, NULL, 'teoruize003@gmail.com', '$2y$10$l5/tl.ee6AywNLWgzj5xyOb7YqcpEk/jBpytI4pcIz2Iofxygldny', '2022-01-01', '', NULL, 'parent', 1, 0, 0, NULL, 'active', NULL, NULL, '2026-05-20 09:52:44', '2026-05-20 01:13:58', '2026-05-20 09:52:44', 'dark');
...
(12, 19, 5, '2026-05-27 20:11:18'),
(13, 20, 15, '2026-05-28 10:46:00');
...
(14, 20, '202622_chest_1', 'weekly', 0, 1, '2026-05-28 09:02:20'),
(15, 20, '202622_chest_3', 'weekly', 0, 1, '2026-05-28 09:02:21'),
(16, 20, '202622_chest_2', 'weekly', 0, 1, '2026-05-28 09:02:23'),
(17, 20, '20260528_dq1', 'daily', 0, 1, '2026-05-28 09:02:33'),
(18, 20, '20260528_dq3', 'daily', 0, 1, '2026-05-28 09:02:34'),
(19, 20, '20260528_dq2', 'daily', 0, 1, '2026-05-28 09:02:35'),
(20, 20, '202622_wq1', 'weekly', 0, 1, '2026-05-28 09:02:37'),
(21, 20, '202622_wq2', 'weekly', 0, 1, '2026-05-28 09:02:37'),
(22, 20, '202622_wq3', 'weekly', 0, 1, '2026-05-28 09:02:39'),
(23, 20, '202622_wq4', 'weekly', 0, 1, '2026-05-28 09:02:39');
...
--
-- Indexes for table `game_age_bands`
--
ALTER TABLE `game_age_bands`
...
--
-- Indexes for table `game_skill_weights`
--
ALTER TABLE `game_skill_weights`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_game_skill` (`game_id`,`skill_key`);
...
ALTER TABLE `parent_controls`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_parent_child` (`parent_id`,`child_id`);

--
-- Indexes for table `parent_learning_targets`
--
ALTER TABLE `parent_learning_targets`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_parent_child_skill` (`parent_id`,`child_id`,`skill_key`);
...
--
-- AUTO_INCREMENT for table `game_skill_weights`
--
ALTER TABLE `game_skill_weights`
...
--
-- AUTO_INCREMENT for table `parent_learning_targets`
--
ALTER TABLE `parent_learning_targets`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `system_logs`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=620;
